...
public class BreathingManager {
	...
	private static final int AIR_FIRST_BREATH_TICKS_ARCOSIAN = Integer.MAX_VALUE;
	...
	public static int getFirstBreath(final EntityLivingBase entityLivingBase){
		...
		try {
			...
			switch(race){
				...
				case 1://Saiyan
					return AIR_FIRST_BREATH_TICKS_SAIYAN;
				case 2://Half-Saiyan
					return AIR_FIRST_BREATH_TICKS_HALFSAIYAN;
				case 3://Namekian
					return AIR_FIRST_BREATH_TICKS_NAMEKIAN;
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
